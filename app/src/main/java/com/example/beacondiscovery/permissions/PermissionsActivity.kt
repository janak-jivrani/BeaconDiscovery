package com.example.beacondiscovery.permissions
    ...
    val requestPermissionsLauncher =
        registerForActivityResult(
            ...
            permissions.entries.forEach {
                ...
                if (isGranted) {
                    if (permissionName == Manifest.permission.BLUETOOTH_SCAN || permissionName == Manifest.permission.BLUETOOTH_CONNECT) {
                        val mBluetoothAdapter = BluetoothAdapter.getDefaultAdapter()
                        if (!mBluetoothAdapter.isEnabled) {
                            mBluetoothAdapter.enable()
                        }
                    } else if (permissionName == Manifest.permission.ACCESS_FINE_LOCATION && Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
